 ...
 *
 * Code generation for function '_coder_set_nei_unit_api'
 *
 */
...
#include "set_nei_unit_emxutil.h"
...
void set_nei_unit_api(const mxArray *prhs[9], const mxArray *plhs[2])
{
  ...
  set_nei_unit(nei_nei_idx, nei_nei_weight, g_n, g_xyidx, nei_filter_n,
...
/* End of code generation (_coder_set_nei_unit_api.c) */
