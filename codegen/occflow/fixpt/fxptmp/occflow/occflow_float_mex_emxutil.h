 ...
 *
 * occflow_float_mex_emxutil.h
 *
 * Code generation for function 'occflow_float_mex_emxutil'
 *
 */

#ifndef __OCCFLOW_FLOAT_MEX_EMXUTIL_H__
#define __OCCFLOW_FLOAT_MEX_EMXUTIL_H__
...
/* End of code generation (occflow_float_mex_emxutil.h) */
