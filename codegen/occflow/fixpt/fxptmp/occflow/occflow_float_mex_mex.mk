START_DIR = /Users/human/Dropbox/Research/Implementation\ in\ papers/2017_IJRR_RecurrentFlowNet/codegen/occflow/fixpt

MATLAB_ROOT = /Applications/MATLAB_R2015b.app
MAKEFILE = occflow_float_mex_mex.mk

include occflow_float_mex_mex.mki


SRC_FILES =  \
	occflow_float_mex_mexutil.c \
	occflow_float_mex_data.c \
	occflow_float_mex_initialize.c \
	occflow_float_mex_terminate.c \
	occflow.c \
...
MEX_FILE_NAME_WO_EXT = occflow_float_mex
...
SYS_INCLUDE += -I "$(START_DIR)/fxptmp/occflow"
SYS_INCLUDE += -I "./interface"
SYS_INCLUDE += -I "$(MATLAB_ROOT)/toolbox/eml/lib/fixedpoint"
...
%.$(OBJEXT) : $(START_DIR)/fxptmp/occflow/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/fxptmp/occflow/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/fxptmp/occflow/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
